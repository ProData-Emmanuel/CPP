...
void test_one_value(); void test_two_values();
...
void test_three_values()
{
    ...
    cout << ". Standard deviation: " << standard_deviation(first_value, second_value, third_value);
    cout << endl << endl;
}
/* END OF FUNCTION */
...
void test_four_values()
{
    ...
    cout << ". Standard deviation: " << standard_deviation(first_value, second_value, third_value, fourth_value);
    cout << endl << endl;
}
/* END OF FUNCTION */
